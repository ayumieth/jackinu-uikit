...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        !isMarket && React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$Q, { width: "24px", color: "primary" })) : (React__default['default'].createElement(Icon$P, { width: "24px", color: "primary" }))),
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Fastswap home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Fastswap home page" }, innerLogo))));
};
