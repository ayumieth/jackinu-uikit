...
var PanelBody = function (_a) {
    ...
    return (React__default['default'].createElement(Container$3, null, links.map(function (entry) {
        ...
        return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname || entry.label === 'NFT Marketplace', className: calloutClass },
        ...
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Flex, { alignItems: "center" },
                ...
                React__default['default'].createElement(NavMenu, null,
                    React__default['default'].createElement(Navigate, { to: "#" }, "Trade"),
                    React__default['default'].createElement(Navigate, { to: "#" }, "Earn"),
                    React__default['default'].createElement(Navigate, { to: "#" }, "Win"),
                    React__default['default'].createElement(Navigate, { to: "#" }, "NFT"))),
            React__default['default'].createElement(Flex, { alignItems: "center" },
