...
var ButtonMenu = function (_a) {
    ...
    var invariant = variant === variants$1.SPECIAL ? variants$1.PRIMARY : variant;
    return (React__default["default"].createElement(StyledButtonMenu, { variant: invariant, style: {
            border: scale === scales$4.SM ? '1.5px solid #566FFE' : 'none',
            borderRadius: scale === scales$4.SM ? '40px' : '16px'
...
var DropdownContent$1 = styled__default["default"].div(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  padding: 16px;\n  max-height: 500px;\n  overflow-y: auto;\n  z-index: ", ";\n  border-radius: ", ";\n"], ["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  background-color: ", ";\n  box-shadow: ", ";\n  padding: 16px;\n  max-height: 500px;\n  overflow-y: auto;\n  z-index: ", ";\n  border-radius: ", ";\n"])), getLeft$1, getBottom$1, function (_a) {
    var theme = _a.theme;
...
var Container$5 = styled__default["default"].div(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent$1, DropdownContent$1);
...
var Container$4 = styled__default["default"].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
...
var Logo = function (_a) {
    ...
    return (React__default["default"].createElement(Flex, null,
        !isMarket && React__default["default"].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default["default"].createElement(Icon$l, { width: "24px", color: "primary" })) : (React__default["default"].createElement(Icon$m, { width: "24px", color: "primary" }))),
        isAbsoluteUrl ? (React__default["default"].createElement(StyledLink, { as: "a", href: href, "aria-label": "Fastswap home page" }, innerLogo)) : (React__default["default"].createElement(StyledLink, { to: href, "aria-label": "Fastswap home page" }, innerLogo))));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default["default"].createElement(PriceLink, { href: "http://info.fastswap.finance/token/0xfea6218871b7851748881a4af6bca63af1b769a8", target: "_blank" },
        ...
        React__default["default"].createElement(Text, { color: "text", bold: true }, "$".concat(cakePriceUsd.toFixed(3))))) : (React__default["default"].createElement(Skeleton, { width: 80, height: 24 }));
};
...
var UserBlock = function (_a) {
    ...
    return (React__default["default"].createElement("div", null, account ? (React__default["default"].createElement(Button, { scale: "sm", variant: "primary", onClick: function () {
        ...
        }, height: "37px", startIcon: React__default["default"].createElement(Icon$x, null), style: { borderRadius: '45px', fontWeight: 450, fontFamily: 'CircularStd' } }, "Connect wallet"))));
};
...
var LangSelector = function (_a) {
    ...
    return (React__default["default"].createElement(Dropdown$1, { position: "bottom", target: React__default["default"].createElement(Button, { variant: "text", padding: "0px 8px", startIcon: React__default["default"].createElement(LanguageIcon, { color: "#36465E" }) },
...
var Pip = styled__default["default"].div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"], ["\n  background-color: ", ";\n  border-radius: 50%;\n  pointer-events: none;\n  height: 8px;\n  position: absolute;\n  right: 0;\n  top: 0;\n  width: 8px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.failure;
});
...
var DropdownContent = styled__default["default"].div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  padding: 16px;\n  max-height: 500px;\n  overflow-y: auto;\n  z-index: 10;\n  border-radius: 20;\n"], ["\n  width: max-content;\n  display: none;\n  flex-direction: column;\n  position: absolute;\n  transform: translate(-50%, 0);\n  left: ", ";\n  bottom: ", ";\n  padding: 16px;\n  max-height: 500px;\n  overflow-y: auto;\n  z-index: 10;\n  border-radius: 20;\n"])), getLeft, getBottom);
...
var Navigate = styled__default["default"].a(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  font-family: CircularStd;\n  font-size: 18px;\n  font-weight: 450;\n  text-decoration: none;\n  color: ", ";\n"], ["\n  font-family: CircularStd;\n  font-size: 18px;\n  font-weight: 450;\n  text-decoration: none;\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var MyButton = styled__default["default"].div(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  background-color:", "\n"], ["\n  background-color:", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
});
var MyDropdown = styled__default["default"].div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  background-color:", "\n"], ["\n  background-color:", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.nav.background;
});
var ChainName = styled__default["default"].span(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  color:", "\n"], ["\n  color:", "\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.text;
});
var listStyle = {
...
var MarketPanel = styled__default["default"].div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  padding-top: ", ";\n"], ["\n  padding-top: ", ";\n"])), function (_a) {
    var showMenu = _a.showMenu;
    return (showMenu ? "66px" : 0);
});
        ...
        React__default["default"].createElement(StyledNav, { showMenu: showMenu, isMarket: isMarket },
            React__default["default"].createElement(Flex, { alignItems: "center" },
                ...
                React__default["default"].createElement(NavMenu, null,
                    React__default["default"].createElement(Navigate, { href: "https://fastswap.finance/" }, topMenu ? topMenu[0].translated : 'Trade'),
                    React__default["default"].createElement(Navigate, { href: "#" }, topMenu ? topMenu[1].translated : 'Earn'),
                    React__default["default"].createElement(Navigate, { href: "#" }, topMenu ? topMenu[2].translated : 'Win'),
                    React__default["default"].createElement(Navigate, { href: "https://nft.fastswap.finance/" }, topMenu ? topMenu[3].translated : 'NFT'))),
            React__default["default"].createElement(Flex, { alignItems: "center" },
                ...
                React__default["default"].createElement(Dropdown, { position: "bottom", target: React__default["default"].createElement(MyButton, { style: {
                            marginRight: '8px',
                            padding: '7px 10px',
                            borderRadius: '40px',
                            alignItems: 'center'
...
var templateObject_1$3, templateObject_2, templateObject_3, templateObject_4, templateObject_5, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11;
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#9A6AFF", background: "#1D1D22", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", inputSecondary: "#66578D", primaryDark: "#0098A1", tertiary: "#353547", text: "#EAE2FC", textDisabled: "#666171", textSubtle: "#A28BD4", borderColor: "#524B63", card: "#0b0c22", gradients: {
...
exports.CircleArrowDownIcon = Icon$R;
exports.CircleArrowUpIcon = Icon$Q;
